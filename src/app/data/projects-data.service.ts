...
export class ProjectsDataService {
  ...
  private projectsData:CardData[] = [
    {
      title: 'SmartControl: Finanzas personales',
    ...
    },
    {
      ...
      completeDescription: '<p>Aplicación que implementa un visualizador de animaciones con una sección dedicada a mostrar las imágenes más populares mediante un sistema de scroll infinito. Con la ayuda de una barra inferior el usuario podrá seleccionar el tipo de imágenes para mostrar. Y, en el menú lateral, en el buscador es posible cargar imágenes acorde a la preferencia del usuario, mostrando también una sección de historial de búsqueda para volver a ver resultados previos.</p><p>La aplicación está diseñada con un enfoque responsive, haciendo uso del framework de estilos CCS "Tailwind", garantizando una experiencia de usuario fluida y consistente tanto en dispositivos de escritorio como en dispositivos móviles.</p>',
